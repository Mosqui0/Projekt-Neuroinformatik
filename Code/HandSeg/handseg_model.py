...
def handseg_model(input_layer, num_classes=3):
  ...
  # last layer
  last_layer = Conv2DTranspose(num_classes, 3, strides=stride_val, padding='same', data_format='channels_last')(encode_relu_3)

  #output = Conv2D(num_classes, 1, data_format = 'channels_last')(last_layer)
